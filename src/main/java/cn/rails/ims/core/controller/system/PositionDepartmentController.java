...
public class PositionDepartmentController{
	...
	@RequestMapping(value = "/{positionId}/getPositionDepartmentById")
	@ResponseBody
	public String getPositionDepartmentById(@PathVariable("positionId") String positionId) {
		String json = "";
		Map<String, Object> map = new HashMap<String, Object>();
		PositionDepartment t = positionDepartmentService.getDepartmentIdByUserId(positionId);
		if (t != null) {
			map.put("status_code", StatusCode.CORRECT.getStatusCode());
